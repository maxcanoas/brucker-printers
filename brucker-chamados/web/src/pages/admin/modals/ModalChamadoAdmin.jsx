        ...
        <div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '20px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <span style={{ color: theme.text }}>{detalhes.tipo}</span>
          ...
          <div style={{ borderTop: `1px solid ${theme.border}`, marginTop: '20px', paddingTop: '20px' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
              <label style={{ color: theme.textSecondary, fontSize: '13px', display: 'block', marginBottom: '6px' }}>Observação</label>
          ...
          {detalhes.avaliacoes?.length > 0 && (
            <div style={{
              marginTop: '24px', padding: '16px', backgroundColor: theme.bg,
              borderRadius: '12px', border: `1px solid ${theme.border}`
            }}>
              <h3 style={{ color: theme.text, fontSize: '16px', margin: '0 0 8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div style={{ display: 'flex', gap: '4px', marginBottom: '6px' }}>
                ...
                <span style={{ color: theme.text, marginLeft: '8px', fontWeight: 600 }}>{detalhes.avaliacoes[0].nota}/5</span>
              </div>
              {detalhes.avaliacoes[0].comentario && (
                <p style={{ color: theme.textSecondary, fontSize: '13px', margin: 0, fontStyle: 'italic' }}>
                  "{detalhes.avaliacoes[0].comentario}"
                </p>
              )}
            </div>
              ...
              {detalhes.chamado_atualizacoes
                ...
                .map(at => (
                  <div key={at.id} style={{
                    ...
                    {at.observacao && <p style={{ color: theme.textSecondary, fontSize: '13px', margin: '8px 0 0' }}>{at.observacao}</p>}
                  </div>
                ))}
            </div>
          )}
